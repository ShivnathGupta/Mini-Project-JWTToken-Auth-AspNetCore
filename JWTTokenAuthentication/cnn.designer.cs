...
namespace cnn
{
    ...
    partial void InsertStudentAssignCourse(StudentAssignCourse instance);
    partial void UpdateStudentAssignCourse(StudentAssignCourse instance);
    partial void DeleteStudentAssignCourse(StudentAssignCourse instance);
    ...
    partial void DeleteTest(Test instance);
		...
		public System.Data.Linq.Table<StudentAssignCourse> StudentAssignCourse
		{
			get
			{
				return this.GetTable<StudentAssignCourse>();
			}
		}
	...
	public partial class AssignSubject : INotifyPropertyChanging, INotifyPropertyChanged
	{
	...
	public partial class Course : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<StudentAssignCourse> _StudentAssignCourse;
    ...
    partial void OnIsActiveChanged();
		...
		public Course()
		{
			this._StudentAssignCourse = new EntitySet<StudentAssignCourse>(new Action<StudentAssignCourse>(this.attach_StudentAssignCourse), new Action<StudentAssignCourse>(this.detach_StudentAssignCourse));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="FK__StudentAs__stdco__3A81B327", Storage="_StudentAssignCourse", ThisKey="Courseid", OtherKey="Stdcourseid", DeleteRule="NO ACTION")]
		public EntitySet<StudentAssignCourse> StudentAssignCourse
		{
			get
			{
				return this._StudentAssignCourse;
			}
			set
			{
				this._StudentAssignCourse.Assign(value);
			}
		}
		...
		private void attach_StudentAssignCourse(StudentAssignCourse entity)
		{
			this.SendPropertyChanging();
			entity.Course = this;
		}
		
		private void detach_StudentAssignCourse(StudentAssignCourse entity)
		{
			this.SendPropertyChanging();
			entity.Course = null;
		}
    ...
    partial void OnIsActiveChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="FK__StudentAs__regid__398D8EEE", Storage="_StudentAssignCourse", ThisKey="Regid", OtherKey="Regidref", DeleteRule="NO ACTION")]
		public EntitySet<StudentAssignCourse> StudentAssignCourse
		{
			get
			{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.StudentAssignCourse")]
	public partial class StudentAssignCourse : INotifyPropertyChanging, INotifyPropertyChanged
	{
		
		private static PropertyChangingEventArgs emptyChangingEventArgs = new PropertyChangingEventArgs(String.Empty);
		
		private int _Stdassignid;
		
		private System.Nullable<int> _Regidref;
		
		private System.Nullable<int> _Stdcourseid;
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnStdassignidChanging(int value);
    partial void OnStdassignidChanged();
    partial void OnRegidrefChanging(System.Nullable<int> value);
    partial void OnRegidrefChanged();
    partial void OnStdcourseidChanging(System.Nullable<int> value);
    partial void OnStdcourseidChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Name="stdassignid", Storage="_Stdassignid", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int Stdassignid
		{
			get
			{
				return this._Stdassignid;
			}
			set
			{
				if ((this._Stdassignid != value))
				{
					this.OnStdassignidChanging(value);
					this.SendPropertyChanging();
					this._Stdassignid = value;
					this.SendPropertyChanged("Stdassignid");
					this.OnStdassignidChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Name="stdcourseid", Storage="_Stdcourseid", DbType="Int")]
		public System.Nullable<int> Stdcourseid
		{
			get
			{
				return this._Stdcourseid;
			}
			set
			{
				if ((this._Stdcourseid != value))
				{
					this.OnStdcourseidChanging(value);
					this.SendPropertyChanging();
					this._Stdcourseid = value;
					this.SendPropertyChanged("Stdcourseid");
					this.OnStdcourseidChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="FK__StudentAs__regid__398D8EEE", Storage="_Registration", ThisKey="Regidref", OtherKey="Regid", IsForeignKey=true)]
		public Registration Registration
		{
			get
			{
			...
			set
			{
							...
							|| (this._Registration.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._Registration.Entity = null;
						previousValue.StudentAssignCourse.Remove(this);
					}
					this._Registration.Entity = value;
					if ((value != null))
					{
						value.StudentAssignCourse.Add(this);
						this._Regidref = value.Regid;
					}
					else
					{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="FK__StudentAs__stdco__3A81B327", Storage="_Course", ThisKey="Stdcourseid", OtherKey="Courseid", IsForeignKey=true)]
		public Course Course
		{
			...
			set
			{
							...
							|| (this._Course.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						value.StudentAssignCourse.Add(this);
						this._Stdcourseid = value.Courseid;
					}
					else
					{
						this._Stdcourseid = default(Nullable<int>);
					}
	...
	public partial class StudentRemarks : INotifyPropertyChanging, INotifyPropertyChanged
	{
